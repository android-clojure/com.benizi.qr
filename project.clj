(defproject qrfetcher/qrfetcher "0.1.0-SNAPSHOT"
  ...
  :dependencies [[org.clojure-android/clojure "1.7.0-r4"]
                 ...
                 [com.pusher/pusher-java-client "1.2.2"]]
             ...
             [:android-common :android-user
              {:dependencies [[org.clojure/tools.nrepl "0.2.10"]]
               ...
               :android {:aot :all-with-unused
                         :manifest-options {:app-name "QrFetcher (debug)"}
                         ;; Uncomment to be able install debug and release side-by-side.
                         ;; :rename-manifest-package "com.benizi.qr.debug"
                         }}]
             :release
             [:android-common
